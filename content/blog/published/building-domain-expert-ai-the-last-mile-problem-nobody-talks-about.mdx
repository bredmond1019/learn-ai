...
<CodeExample
  ...
  language="text"
  code={`Model Performance Progression:
...
<CodeExample
  title="Domain Intelligence Flow"
  language="text"
...
<CodeExample
  title="Domain Knowledge Addition"
  language="typescript"
  code={`interface DomainKnowledgeAddition {
  case_id: string;
...
<CodeExample
  title="Basic Measurement Setup"
  language="python"
  code={`class DomainExpertReview:
    def __init__(self):
...
<CodeExample
  title="Improvement Workflow"
  language="python"
  code={`def improvement_cycle(failure_mode_data):
