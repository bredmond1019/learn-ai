...
<Diagram type="mindmap" title="The 12-Factor Agent Framework">
```mermaid
mindmap
...
<Diagram type="flow" title="Micro-Agent Composition Pattern">
```mermaid
graph TB
...
<Diagram type="flow" title="State Management Flow">
```mermaid
stateDiagram-v2
