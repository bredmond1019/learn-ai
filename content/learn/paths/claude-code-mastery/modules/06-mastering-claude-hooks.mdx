...
<CodeExample
  title="Multi-Agent Observability Flow"
  language="text"
  code={`┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
...
<CodeExample
  title="Universal Event Streaming Hook"
  language="python"
  code={`#!/usr/bin/env uv run
# /// script
...
<CodeExample
  title="Complete Observability Hook Configuration"
  language="json"
  code={`{
  "hooks": {
    "PreToolUse": [{
...
<CodeExample
  title="Agent Health Check Script"
  language="python"
  code={`#!/usr/bin/env uv run
...
<CodeExample
  title="Detect File Conflicts Between Agents"
  language="python"
  code={`#!/usr/bin/env uv run
