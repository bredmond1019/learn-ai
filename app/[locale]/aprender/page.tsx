...
import { learningPaths, concepts, type Locale } from '@/lib/content/learning/learn';
import { createTranslator } from '@/lib/translations';

export const metadata = {
  title: 'Aprender IA Agêntica & Servidores MCP',
  description: 'Domine os fundamentos de sistemas de IA agêntica e servidores MCP com a abordagem focada em ensino de Brandon para conceitos complexos de IA.',
};
